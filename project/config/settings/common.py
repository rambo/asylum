...
HOLVI_USER = env('HOLVI_USER', default=None)
HOLVI_PASSWORD = env('HOLVI_PASSWORD', default=None)
...
NORDEA_BARCODE_IBAN = env('NORDEA_BARCODE_IBAN', default=None)
...
VELKOJA_NORDEACHECKER_GRACE_DAYS = env('VELKOJA_NORDEACHECKER_GRACE_DAYS', default=60)
VELKOJA_EXCLUDE_TAGS = env.list('VELKOJA_EXCLUDE_TAGS', default=[])
